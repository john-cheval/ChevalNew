                          ...
                          >
                            <div className="flex space-x-4 xl:gap-x-8 items-center">
                              ...
                              <div className="space-y-2 xl:space-y-3">
                                ...
                                {Object.values(data?.service_list_pages  || {})?.length > 0 ? (
                                <div className="text-xs xl:text-base font-satoshi font-normal flex flex-wrap gap-x-1 max-w-[300px] lg:max-w-[450px] xl:max-w-[600px]">
                                 ...
                                 Object?.values(data?.service_list_pages)?.map((servic, idy) => (
                                      <span
                                        key={idy}
                                        className="text-[#101763] leading-[182%]"
                                      >
                                        <Link
                                        href={`/service/${data?.post_name}/${servic?.post_name}`}
                                      > 
                                        {servic?.post_title}
                                         </Link>
                                        {idy !==
                                 ...
                                 <div className="text-xs xl:text-base font-satoshi font-normal flex flex-wrap gap-x-1 max-w-[300px] lg:max-w-[450px] xl:max-w-[600px]">
                                  ...
                                  data?.list_page_services?.map((servic, idy) => (
                                      <span
                                        key={idy}
                                        className="text-[#101763] leading-[182%]"
                                      >
