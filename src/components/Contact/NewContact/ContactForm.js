...
const ContactForm = ({ services, title, desc,isForm }) => {
  ...
  return (
    ...
    >
      <div className={` md:space-y-10 space-y-6 flex flex-col ${isForm ? "":'lg:space-y-[57px] sm:justify-center sm:items-center'} `}>
        ...
        >
          <div className={`flex sm:items-center ${isForm? 'flex-col space-y-5':' flex-col sm:flex-row sm:space-x-5 space-y-5 sm:space-y-0'}   `} >
